...
//handler.postDelayed()
        ...
        binding.userRoleTxt.setText(Prefs.getString(Globals.name, ""));
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        binding.userName.setText(Prefs.getString(Globals.name, ""));
        binding.proPic.setText(String.valueOf(Prefs.getString(Globals.name, "").charAt(0)).toUpperCase());
...
//        JsonObject employeeValue = new JsonObject();
//        employeeValue.addProperty("_SalesEmployeeCode","");
            ...
            public void onResponse(Call<CounterResponse> call, Response<CounterResponse> response) {
                if (response != null) {
                    if (response.body().getValue().size() > 0) {
                        ...
                        String leadC = response.body().getValue().get(0).getLeads();
                        Log.d("leadCounter ", leadC);
