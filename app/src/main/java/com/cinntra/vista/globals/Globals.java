...
import com.cinntra.vista.model.Items;
...
import com.cinntra.vista.model.StagesItem;
...
public class Globals {
    ...
    public static String CURRENCY_AT_LOGIN     = "_CURRENCY_AT_LOGIN";
...
//    public static String NewBaseUrlSuperAdmin = "http://43.204.160.245:8003/";// http://43.204.160.245:8003
    ...
    public static String PDFURL = "http://vistasaas.bridgexd.com/assets/html/";
    ...
    public static void selectTime(Context context, EditText editText) {
        ...
        TimePickerDialog timePickerDialog = new TimePickerDialog(context, new TimePickerDialog.OnTimeSetListener() {
            ...
            public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
                ...
                editText.setText(DateFormat.format("HH:MM", myTime).toString().toUpperCase());
