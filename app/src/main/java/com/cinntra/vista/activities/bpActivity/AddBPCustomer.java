...
import static com.cinntra.vista.activities.AddOpportunityActivity.LeadCode;
...
import com.cinntra.vista.adapters.LeadListAdapter;
...
import com.cinntra.vista.model.ContactEmployeesModel;
...
import com.cinntra.vista.spinneradapter.BusinessTypeSearchableSpinnerAdapter;
import com.cinntra.vista.spinneradapter.SourceSearchableSpinnerAdapter;
import com.cinntra.vista.spinneradapter.ZoneSearchableSpinnerAdapter;
...
public class AddBPCustomer extends MainBaseActivity implements View.OnClickListener {
    ...
    private void setUpZoneSpinner() {
        ...
        binding.fragmentAddpartnergeneral.saerchableSpinnerZone.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                // Check if the correct item is selected
                Log.e("SPINNER SEARCH", "onItemClick: " + zoneDataList.get(i).getName());
