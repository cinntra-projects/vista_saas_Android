...
import com.cinntra.vista.adapters.Invoice_Item_Adapter;
import com.cinntra.vista.databinding.ActivitySelectedItemBinding;
import com.cinntra.vista.globals.Globals;
import com.cinntra.vista.globals.MainBaseActivity;



import static com.cinntra.vista.activities.CreateContact.ITEMSCODE;
...
//     ProgressBar loader;
    ...
    private void setAdapter() {
        ...
        binding.itemsRecycler.setLayoutManager(new LinearLayoutManager(com.cinntra.vista.activities.InvoiceItemList.this, RecyclerView.VERTICAL, false));
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.new_quatos:
                Intent intent = new Intent(com.cinntra.vista.activities.InvoiceItemList.this, ItemsList.class);
