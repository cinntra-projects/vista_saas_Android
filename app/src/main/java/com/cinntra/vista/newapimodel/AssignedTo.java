...
public class AssignedTo implements Parcelable {
    ...
    public final static Creator<AssignedTo> CREATOR = new Creator<AssignedTo>() {
        ...
        public com.cinntra.vista.newapimodel.AssignedTo createFromParcel(android.os.Parcel in) {
            return new com.cinntra.vista.newapimodel.AssignedTo(in);
        }

        public com.cinntra.vista.newapimodel.AssignedTo[] newArray(int size) {
            return (new com.cinntra.vista.newapimodel.AssignedTo[size]);
        }
