...
import com.cinntra.vista.fragments.OrderDetailFragment;
import com.cinntra.vista.fragments.Order_Update_Fragment;
...
public class Open_Order_Adapter extends RecyclerView.Adapter<Open_Order_Adapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.tvTotalAmount.setText(obj.getDocTotal());
